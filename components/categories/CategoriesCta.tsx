...
export default function CategoriesCta() {
  return (
    <section className="mt-16 sm:mt-24 py-16 sm:py-20 border-t border-zinc-900 bg-linear-to-b from-black via-zinc-950/70 to-black relative overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-2xl mx-auto space-y-6 px-4">
        ...
        <p className="font-sans text-sm sm:text-base text-zinc-400 max-w-lg mx-auto leading-relaxed">
          Explore recognized work across the UK, or nominate a business or creator for consideration.
        </p>
